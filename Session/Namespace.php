...
require_once 'Opis/Session.php';


/**
 * @see Zend_Session_Abstract
 */
require_once 'Opis/Session/Abstract.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Opis_Session_Namespace extends Opis_Session_Abstract implements IteratorAggregate
{
    ...
    public function __construct($namespace = 'Default', $singleInstance = false)
    {
    	...
    	// prd($_SESSION);
        Opis_Session::start(true); // attempt auto-start (throws exception if strict option set)
